...
export default function OrderScreen() {
  ...
  return loading ? (
    ...
    <div>
      ...
      <h1 className="my-3">Đã hoàn thành đơn hàng </h1>
      <Row>
        <Col md={8}>
          <Card className="mb-3">
            <Card.Body>
        ...
        <Col md={4}>
          <Card className="mb-3">
            <Card.Body>
              <Card.Title>Hóa đơn </Card.Title>
              <ListGroup variant="flush">
                <ListGroup.Item>
                  <Row>
                    <Col>Sản phẩm </Col>
                    <Col>{order.itemsPrice.toFixed(2)}.VND</Col>
                  </Row>
                </ListGroup.Item>
                ...
                <ListGroup.Item>
                  <Row>
                    <Col>Phí Ship</Col>
                    <Col>{order.taxPrice.toFixed(2)}.VND</Col>
                  </Row>
                </ListGroup.Item>
                <ListGroup.Item>
                  <Row>
                    ...
                    <Col>
                      <strong>{order.totalPrice.toFixed(2)}.VND</strong>
                    </Col>
                  </Row>
                </ListGroup.Item>
