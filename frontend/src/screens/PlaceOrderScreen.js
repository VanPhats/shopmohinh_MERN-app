...
export default function PlaceOrderScreen() {
  ...
  return (
    <div>
      ...
      <h1 className="my-3">Thông tin đặt hàng </h1>
      <Row>
        <Col md={8}>
          <Card className="mb-3">
            <Card.Body>
            ...
            <Card.Body>
              ...
              <ListGroup variant="flush">
                <ListGroup.Item>
                  <Row>
                    <Col>Sản phẩm </Col>
                    <Col>{cart.itemsPrice.toFixed(2)}.VND</Col>
                  </Row>
                </ListGroup.Item>
                ...
                <ListGroup.Item>
                  <Row>
                    <Col>Phí ship</Col>
                    <Col>{cart.taxPrice.toFixed(2)}.VND</Col>
                  </Row>
                </ListGroup.Item>
                <ListGroup.Item>
                  <Row>
                    ...
                    <Col>
                      <strong>{cart.totalPrice.toFixed(2)}VND</strong>
                    </Col>
                  </Row>
                </ListGroup.Item>
                <ListGroup.Item>
